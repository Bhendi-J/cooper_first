  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-hero": "linear-gradient(135deg, hsl(226 71% 50%) 0%, hsl(262 83% 58%) 50%, hsl(330 81% 60%) 100%)",
      },
      boxShadow: {
        ...
        soft: "0 4px 20px hsl(226 71% 50% / 0.08)",
        card: "0 4px 20px hsl(226 71% 50% / 0.05)",
        "card-hover": "0 12px 40px hsl(226 71% 50% / 0.15), 0 4px 20px hsl(262 83% 58% / 0.1)",
      },
    },
  },
